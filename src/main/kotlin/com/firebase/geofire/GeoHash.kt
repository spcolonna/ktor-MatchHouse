...
import com.example.com.firebase.geofire.Direction

object GeoHash {
    private const val BASE32 = "0123456789bcdefghjkmnpqrstuvwxyz"
    private val BORDERS = mapOf(
        Direction.TOP to mapOf("even" to "bcfguvyz", "odd" to "prxz"),
        Direction.BOTTOM to mapOf("even" to "0145hjnp", "odd" to "028b"),
        Direction.RIGHT to mapOf("even" to "prxz", "odd" to "bcfguvyz"),
        Direction.LEFT to mapOf("even" to "028b", "odd" to "0145hjnp")
    )
    private val NEIGHBORS = mapOf(
        Direction.TOP to mapOf("even" to "p0r21436x8zb9dcf5h7kjnmqesgutwvy", "odd" to "bc01fg45238967deuvhjyznpkmstqrwx"),
        Direction.BOTTOM to mapOf("even" to "14365h7k9dcfesgujnmqp0r2twvyx8zb", "odd" to "238967debc01fg45kmstqrwxuvhjyznp"),
        Direction.RIGHT to mapOf("even" to "bc01fg45238967deuvhjyznpkmstqrwx", "odd" to "p0r21436x8zb9dcf5h7kjnmqesgutwvy"),
        Direction.LEFT to mapOf("even" to "238967debc01fg45kmstqrwxuvhjyznp", "odd" to "14365h7k9dcfesgujnmqp0r2twvyx8zb")
    )
    ...
    private fun calculateAdjacent(hash: String, direction: Direction): String {
